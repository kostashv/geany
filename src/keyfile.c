...
static void save_dialog_prefs(GKeyFile *config)
{
	...
	g_key_file_set_boolean(config, PACKAGE, "tab_popup_show_path", interface_prefs.tab_popup_show_path);
	g_key_file_set_integer(config, PACKAGE, "tab_popup_path_begin", interface_prefs.tab_popup_path_begin);
...
static void load_dialog_prefs(GKeyFile *config)
{
	...
	interface_prefs.tab_popup_show_path = utils_get_setting_boolean(config, PACKAGE, "tab_popup_show_path", FALSE);
	interface_prefs.tab_popup_path_begin = utils_get_setting_integer(config, PACKAGE, "tab_popup_path_begin", TAB_POPUP_PATH_BEGIN_ROOT);
